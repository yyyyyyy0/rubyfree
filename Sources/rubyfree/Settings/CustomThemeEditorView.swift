...
///  2. Changes are preview-applied to the overlay immediately (live preview).
///  3. "保存" writes the custom theme and sets `themeID = "custom"`.
///  4. "リセット" discards buffer state (does not delete the saved custom theme;
